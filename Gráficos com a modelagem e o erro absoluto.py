...
print("Maior valor do erro:", max(erro_absoluto))
print("Menor valor do erro:", min(erro_absoluto))
...
ax2 = ax1.twinx()
ax2.set_ylabel('Erro absoluto (rpm)', color='tab:orange')
ax2.plot(tempo, erro_absoluto, label='Erro', color='tab:orange')
ax2.tick_params(axis='y', labelcolor='tab:orange')
ax2.set_ylim(-280, 140)
ax2.set_yticks([x/1 for x in range(-280, 141, 70)])  # Definir marcações de 450 em 450 RPM
